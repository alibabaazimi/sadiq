<template>
    <nav class="main-header navbar navbar-expand-md navbar-light navbar-white sticky-top pl-3 pr-3 justify-content-end">
        ...
        <router-link to="/posts/new" class="btn btn-danger">
            Post for free!
        </router-link>
        ...
        <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
            ...
            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <router-link to="/logout" class="btn btn-default btn-flat float-right">Sign out</router-link>
                </li>
            </ul>
            </li>
...
export default {
    created() {
        ...
        if (this.loggedIn) {
            this.$store.dispatch('auth/getCurrentUser', localStorage.getItem('access_token'));
        }
    },
    computed: {
        loggedIn() {
