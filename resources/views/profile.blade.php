    ...
    <div class="card card-primary card-outline">
        ...
        <div class="text-center">
            <img class="profile-user-img img-fluid img-circle"
                src="{{ auth()->user()->image ? asset('storage/'.auth()->user()->image->path) : asset('/profile-default.jpg') }}"
                alt="User profile picture">
        </div>
        <div class="text-center">
            <button class="btn-xs btn-primary" data-toggle="modal" data-target="#modal-profile-photo">Change</button>
        </div>
        <h3 class="profile-username text-center">{{ $cur_user->name ?? "" }}</h3>
...
<div class="modal fade" id="modal-profile-photo" style="display: none;" aria-hidden="true">
        ...
        <div class="modal-body">
                <div class="row">
                    <div class="col-md-6 offset-md-3">
                        <img id="profile-image" class="img-fluid" src="{{ asset('profile-default.jpg') }}">
...
$('#cropButton').click(function(e) {
    ...
    if (cropper) {
        ...
        $('#profile-image').attr('src', canvas.toDataURL());
        $('#profile-image').cropper('destroy');
...
$('#uploadButton').click(function(event) {
    ...
    canvas.toBlob((blob) => {
        ...
        formData.append('image-file', blob, 'file.jpg');
        $.ajax({    
            url: '/profileUpload',
            type: 'POST',
            //dataType: 'json',
            ...
            {
                //location.reload();
                $('.profile-user-img').attr('src', data.file);
                $('#modal-profile-photo').modal('hide');
