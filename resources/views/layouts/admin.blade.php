    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview {{ request()->segment(1) == 'ads' ? "menu-open" : "" }}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/ads" class="nav-link {{ request()->is('ads') ? "active" : "" }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Home</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/ads/new-ad" class="nav-link {{ request()->is('ads/new-ad') ? "active" : "" }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>New Ad</p>
                </a>
              </li>
